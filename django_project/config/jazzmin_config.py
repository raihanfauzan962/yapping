...
JAZZMIN_SETTINGS = {
    ...
    "welcome_sign": "Welcome Yapper!",

    # Copyright on the footer
    "copyright": "Raihan Fauzan",
    ...
    "order_with_respect_to": ["articles", "accounts", "auth"],
    ...
    "icons": {
        ...
        "articles.Feedback": "fas fa-comment-alt",     
        "articles.UserRecording": "fas fa-microphone"
    },
